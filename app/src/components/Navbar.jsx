                ...
                <div key={link.name} className="relative group">
                  {link.dropdown ? (
                    <>
                      <Link 
                        to={link.path}
                        className={`flex items-center gap-1 px-4 py-2 text-sm font-medium text-white uppercase tracking-wide hover:bg-white/10 rounded-md transition-all duration-300 ${
