        ...
        <section className="pt-4 pb-6 grid grid-cols-1 md:grid-cols-12 gap-3 items-stretch">
           ...
           <div className="md:col-span-4 flex flex-col gap-3">
              <div className="flex-grow bg-sm-blue rounded-[25px] overflow-hidden relative shadow-lg group border border-blue-400">
                 <img src="https://images.unsplash.com/photo-1521587760476-6c12a4b040da?w=800&q=80" className="w-full h-full object-cover brightness-90 transition-all duration-700 hover:scale-110 opacity-60 group-hover:opacity-100" alt="Library" />
