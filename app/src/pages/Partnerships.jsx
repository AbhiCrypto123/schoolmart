...
const Partnerships = () => {
  ...
  if (loading) return <div className="min-h-screen bg-white flex items-center justify-center font-black uppercase tracking-widest text-[#004a8e] text-sm">Loading Partnership Ecosystem...</div>;
        ...
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row md:items-center justify-between gap-8">
          <div className="max-w-2xl">
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="text-sm-blue text-[10px] font-black uppercase tracking-[0.3em]">{hero.badge}</span>
            </div>
            <h1 
          ...
          <div className="grid grid-cols-2 gap-4 shrink-0">
             {hero.stats?.map((stat, i) => (
                <div key={i} className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 text-center w-32 md:w-40">
                   ...
                   <span className="text-[9px] font-black text-gray-400 uppercase tracking-widest leading-none mt-1">{stat.label}</span>
                </div>
             ))}
          </div>
        </div>
          ...
          <div className="bg-white rounded-[40px] p-10 w-full max-w-lg shadow-2xl relative overflow-hidden" onClick={e => e.stopPropagation()}>
            ...
            <form className="space-y-3">
              ...
              <button 
                ...
                className="w-full py-4 bg-sm-blue text-white font-black rounded-2xl uppercase tracking-widest text-[10px] shadow-xl shadow-blue-500/10 hover:bg-gray-900 transition-all mt-4"
              >
                Connect on WhatsApp
              </button>
            </form>
