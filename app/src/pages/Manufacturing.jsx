...
const Manufacturing = () => {
  ...
  if (loading) return <div className="min-h-screen bg-white flex items-center justify-center font-black uppercase tracking-widest text-[#004a8e] text-sm">Loading Manufacturing Architecture...</div>;
      ...
      <div className="max-w-7xl mx-auto px-4 lg:px-6 pt-4 lg:pt-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-center mb-8 lg:mb-12 py-6">
           <div className="lg:col-span-6 space-y-6 lg:pr-10">
              <span className="inline-flex items-center gap-2 px-4 py-1.5 bg-gray-50 text-gray-900 font-black rounded-full text-[9px] uppercase tracking-[0.2em] border border-gray-200">
              ...
              />
              <p className="text-gray-400 text-[11px] lg:text-sm font-bold uppercase tracking-[0.1em] leading-relaxed max-w-lg">
                 {hero.description}
              </p>
              <div className="flex flex-wrap gap-3 pt-2">
                 <button className="px-8 py-4 bg-[#004a8e] text-white font-black rounded-2xl hover:bg-gray-900 transition-all uppercase tracking-[0.2em] text-[10px] flex items-center gap-3 shadow-sm">
                 ...
                 <div className="flex items-center gap-3 px-6 py-4 bg-gray-50 rounded-2xl border border-gray-200">
                    ...
                    <span className="text-[9px] font-black uppercase tracking-widest text-gray-500">ISO 9001 Certified Facilities</span>
                 </div>
              </div>
           </div>
           ...
           <div className="lg:col-span-6 grid grid-cols-2 gap-3 h-[400px] lg:h-[500px]">
              ...
              <div className="flex flex-col gap-3">
                 ...
                 <div className="flex-1 bg-[#004a8e] rounded-[30px] lg:rounded-[40px] p-8 flex flex-col justify-end text-white shadow-sm overflow-hidden relative">
                    ...
                    <span className="text-[9px] font-black uppercase tracking-widest opacity-60">{hero.partnerLabel}</span>
                 </div>
              </div>
           </div>
        </div>
        ...
        <div className="space-y-4 mb-8 lg:mb-12">
           <div className="flex items-center justify-between mb-8 pb-4 border-b border-gray-100">
              ...
              <span className="text-[10px] font-black text-[#004a8e] uppercase tracking-[0.3em]">{capabilities.subline}</span>
           </div>
