      ...
      <div className="max-w-7xl mx-auto px-4">
              ...
              {catalogues.map((item, i) => (
                 <div key={i} className="break-inside-avoid bg-white p-2 rounded-[25px] border border-gray-100 shadow-sm transition-all duration-500 hover:shadow-2xl group cursor-pointer hover:-translate-y-2 relative overflow-hidden">
                    <div className="relative h-48 rounded-[20px] overflow-hidden mb-4">
                       <img src={item.img} alt={item.title} className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110 grayscale" onError={e => e.target.src='https://images.unsplash.com/photo-1524758631624-e2822e304c36?w=600&q=80'} />
        ...
        <section className="py-6 border-t border-gray-100 grid grid-cols-1 lg:grid-cols-2 gap-8 items-center mt-6">
           ...
           <div className="order-1 lg:order-2 rounded-[30px] overflow-hidden shadow-2xl h-[400px]">
              <img src={d.infoGrid?.img || 'https://images.unsplash.com/photo-1524995997946-a1c2e315a42f?w=1000&q=80'} alt="Info" className="w-full h-full object-cover grayscale brightness-75 hover:grayscale-0 transition-all duration-1000" />
           </div>
        </section>
      </div>
    </main>
