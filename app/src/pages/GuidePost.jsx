    ...
    <main className="min-h-screen bg-white pb-10 font-body">
      ...
      <div className="bg-gray-50 border-b border-gray-100 py-3">
        <div className="max-w-4xl mx-auto px-4 flex items-center justify-between">
           <button onClick={() => navigate(-1)} className="flex items-center gap-2 text-[10px] font-black uppercase tracking-widest text-[#004a8e] hover:bg-white px-4 py-2 rounded-full transition-all">
              <ArrowLeft size={16} /> Back to Guides
           </button>
           <div className="flex items-center gap-4 text-gray-300">
              <span className="text-[9px] font-black uppercase tracking-[0.2em] hidden sm:block">Strategy Hub 2025</span>
              <BookOpen size={16} />
           </div>
        </div>
      </div>
      ...
      <div className="max-w-4xl mx-auto px-4 pt-8 lg:pt-12">
        ...
        <div className="text-center mb-12">
           <span className="inline-block px-4 py-1.5 bg-blue-50 text-[#004a8e] font-black rounded-full text-[9px] uppercase tracking-[0.2em] mb-6 border border-blue-100">
              {guideData.badge}
           </span>
                 ...
                 <div className="space-y-6">
                    ...
                    {step.insight && (
                      <div className="bg-blue-50/50 p-6 lg:p-8 rounded-[30px] border border-blue-100 flex items-start gap-4">
                         ...
                         <p className="text-[11px] lg:text-sm font-black text-[#004a8e] uppercase tracking-widest leading-relaxed italic">
                            "{step.insight}"
                         </p>
                      </div>
                    )}
                    ...
                    {step.action && (
                      <div className="flex items-center gap-4 pt-2">
                         ...
                         <span className="text-[10px] font-black text-gray-400 uppercase tracking-widest">Action Point:</span>
                         <span className="text-[10px] font-black text-gray-900 uppercase tracking-widest"> {step.action}</span>
                      </div>
                    )}
                 </div>
              </section>
           ...
           {guideData.summaryPoints.map((point, i) => {
              ...
              return (
                <div key={i} className="flex flex-col items-center gap-4 p-6 bg-gray-50 rounded-[30px] border border-transparent hover:border-[#004a8e] hover:bg-white transition-all group">
                  ...
                  <span className="text-[9px] font-black text-gray-500 group-hover:text-gray-900 uppercase tracking-widest text-center">{point.t}</span>
                </div>
              );
           })}
        </div>
        ...
        <div className="mt-16 bg-[#004a8e] rounded-[40px] p-10 lg:p-14 text-center text-white shadow-2xl relative overflow-hidden">
           ...
           <p className="text-[10px] lg:text-[11px] font-black uppercase tracking-[0.2em] opacity-60 max-w-lg mx-auto mb-10 leading-loose">
              OUR STRATEGY PANELS WORK WITH TOP SCHOOLS GLOBALLY TO RE-ENGINEER THEIR ENROLMENT MODELS AND ACADEMIC STANDARDS.
           </p>
           <button 
             onClick={() => navigate('/registration')}
             className="px-10 py-5 bg-white text-[#004a8e] font-black rounded-full uppercase tracking-[0.2em] shadow-xl hover:scale-105 active:scale-95 transition-all text-[11px]"
           >
