                      ...
                      <tr key={u.id} className={`hover:bg-blue-50/30 cursor-pointer transition-colors ${selectedUser?.id === u.id ? 'bg-blue-50/50' : ''}`}
                        ...
                        <td className="px-4 py-3">
                          <div className="flex items-center gap-1" onClick={e => e.stopPropagation()}>
                            <button onClick={() => handleRoleToggle(u.id, u.role)} className="p-1.5 text-gray-400 hover:text-purple-600 rounded-lg hover:bg-purple-50" title="Toggle role">
                              <Shield size={14} />
                            </button>
                            <button onClick={() => handleDelete(u.id)} className="p-1.5 text-gray-400 hover:text-red-600 rounded-lg hover:bg-red-50" title="Delete">
                              <Trash2 size={14} />
                            </button>
                          </div>
                        </td>
