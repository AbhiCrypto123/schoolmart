        ...
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row md:items-center justify-between gap-8">
          <div className="max-w-2xl">
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="text-sm-blue text-[13px] font-black uppercase tracking-[0.3em]">Institutional Academy</span>
            </div>
            ...
            <p className="text-gray-500 text-[13px] font-bold uppercase tracking-widest leading-relaxed max-w-xl mb-8">
          ...
          <div className="grid grid-cols-2 gap-4 shrink-0">
             <div className="bg-gray-50 p-6 rounded-2xl shadow-sm border border-gray-100 text-center w-32 md:w-40">
                ...
                <span className="text-[12px] font-black text-gray-400 uppercase tracking-widest leading-none mt-1">Runs</span>
             </div>
             <div className="bg-gray-50 p-6 rounded-2xl shadow-sm border border-gray-100 text-center w-32 md:w-40">
                <span className="text-2xl font-black text-sm-blue block">4.9</span>
                <span className="text-[12px] font-black text-gray-400 uppercase tracking-widest leading-none mt-1">Rating</span>
             </div>
          </div>
        </div>
      </section>
            ...
            {WORKSHOPS.map((w, i) => (
              <div key={i} className="flex flex-col bg-white p-8 rounded-[35px] border border-gray-100 hover:shadow-2xl transition-all group">
                 ...
                 <div className="space-y-3 mb-8 pt-6 border-t border-gray-50">
                    <div className="flex items-center gap-2 text-gray-400 text-[13px] font-black uppercase tracking-widest">
                       <MapPin size={14} className="text-sm-blue" /> {w.location}
                    </div>
                    <div className="flex items-center gap-2 text-gray-400 text-[13px] font-black uppercase tracking-widest">
                       <Clock size={14} className="text-sm-blue" /> {w.duration}
                    </div>
                    <div className="flex items-center gap-2 text-gray-900 text-[13px] font-black uppercase tracking-widest">
                       FEE: <span className="text-sm-blue">{w.price}</span>
                    </div>
                 </div>
                 
                 <button className="w-full py-4 bg-gray-50 text-gray-900 font-black rounded-2xl text-[13px] uppercase tracking-widest group-hover:bg-sm-blue group-hover:text-white transition-all shadow-xl shadow-blue-500/10">
                    Reserve My Spot
                 </button>
              </div>
            ))}
         ...
         <div className="max-w-7xl mx-auto rounded-[40px] bg-sm-blue p-8 lg:p-12 shadow-2xl relative overflow-hidden group">
            ...
            <div className="max-w-xl relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-8">
               <div>
                  ...
                  <p className="text-white/70 text-[13px] font-black uppercase tracking-widest leading-loose">
                     Customized faculty training programs delivered at your doorstep.
                  </p>
               </div>
               <a href="tel:+919966109191" className="inline-flex items-center gap-2 px-8 py-4 bg-white text-sm-blue font-black rounded-xl text-[13px] uppercase tracking-widest hover:bg-gray-900 hover:text-white transition-all shadow-xl whitespace-nowrap active:scale-95 duration-500">
