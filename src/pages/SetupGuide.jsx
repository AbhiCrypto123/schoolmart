    ...
    <main className="min-h-screen bg-gray-50 text-gray-900">
      ...
      <section className="bg-white py-12 px-6 border-b border-gray-100 text-center">
        <div className="max-w-4xl mx-auto">
          <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-emerald-50 text-emerald-600 border border-emerald-100 rounded-full mb-6">
            <Shield size={12} />
            <span className="text-[11px] font-black uppercase tracking-[0.3em]">Institutional Roadmap</span>
          </div>
      ...
      <section className="py-16 px-6 bg-gray-900 text-white">
         <div className="max-w-7xl mx-auto p-12 rounded-[50px] border border-white/10 flex flex-col md:flex-row items-center justify-between gap-12 group">
            <div className="md:w-2/3">
               ...
               <button className="inline-flex items-center gap-2 px-8 py-4 bg-emerald-500 text-white font-black rounded-xl text-[12px] uppercase tracking-widest hover:bg-white hover:text-emerald-600 transition-all shadow-xl shadow-emerald-500/10 active:scale-95 duration-500 group">
            ...
            <div className="md:w-1/3 flex justify-center">
               <div className="w-48 h-64 bg-white rounded-3xl p-6 flex flex-col justify-end text-gray-950 relative overflow-hidden group-hover:scale-105 transition-transform">
                  ...
                  <span className="text-[11px] font-black uppercase tracking-widest mb-1 opacity-50">Score</span>
      ...
      <section className="py-16 px-6 text-center">
         <div className="max-w-2xl mx-auto">
            ...
            <a href="tel:+919966109191" className="inline-flex items-center gap-4 px-10 py-5 bg-gray-900 text-white font-black rounded-xl text-[12px] uppercase tracking-widest hover:bg-sm-blue transition-all shadow-xl shadow-blue-500/10 h-16 w-full md:w-auto flex justify-center">
