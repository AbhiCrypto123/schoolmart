            ...
            <div className="max-w-7xl mx-auto px-6 pb-20">
                <div className="text-center mb-20">
                    <h1 className="text-6xl lg:text-8xl font-black text-gray-900 uppercase tracking-tighter mb-6">
                        Value <span className="text-sm-blue">Transparent</span>
                    </h1>
                    <p className="max-w-2xl mx-auto text-xl text-gray-400 font-medium">
                        Optimized costs for maximum institutional impact. Direct-to-school pricing with no hidden overheads.
                    </p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    {[
                        ...
                        <div key={plan.title} className="p-10 rounded-[40px] border border-gray-100 bg-gray-50 hover:bg-white hover:shadow-2xl transition-all group">
