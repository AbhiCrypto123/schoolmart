    ...
    return (
        <div className="bg-white min-h-screen">
            ...
            <div className="max-w-7xl mx-auto px-6 py-8">
                <button 
                    onClick={() => navigate(-1)}
                    className="text-[11px] font-black uppercase tracking-widest text-gray-400 hover:text-sm-blue transition-colors flex items-center gap-2"
                >
                ...
                <div className="flex flex-col lg:flex-row gap-16">
                    ...
                    <div className="lg:w-1/2">
                        <div className="mb-6 inline-flex items-center gap-2 px-4 py-1.5 bg-sm-blue/10 rounded-full border border-sm-blue/20">
                            ...
                            <span className="text-[10px] font-black text-sm-blue uppercase tracking-widest">Process Guide</span>
                        </div>
                        <h1 className="text-5xl lg:text-7xl font-black text-gray-900 uppercase tracking-tighter leading-[0.9] mb-8">
                            How It <br /><span className="text-sm-blue">Works</span>
                        </h1>
                        <p className="text-xl text-gray-500 font-medium leading-relaxed mb-10">
                            SchoolMart is a tech-enabled platform that bridges the gap between educational visionaries and infrastructure execution.
                        </p>
                    ...
                    <div className="lg:w-1/2">
                        <div className="relative aspect-square rounded-[40px] overflow-hidden shadow-2xl">
                            ...
                            <div className="absolute bottom-10 left-10 text-white">
                                <h4 className="text-2xl font-black uppercase tracking-tighter">NEP 2020 Compliant</h4>
                                <p className="opacity-70 text-sm">India's first modular infrastructure hub.</p>
                            </div>
                        </div>
                    </div>
                </div>
