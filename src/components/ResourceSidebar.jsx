    ...
    <div className="w-full lg:w-72 shrink-0 space-y-4 sticky top-24">
      <div className="bg-white rounded-[25px] border border-gray-100 shadow-sm overflow-hidden flex flex-col">
          <div className="bg-sm-blue px-6 py-4 flex items-center gap-3">
             ...
             <h3 className="text-white font-black uppercase text-[13px] tracking-widest">Resources</h3>
          </div>
             ...
             {RESOURCES.map((r, i) => (
                ...
                >
                  <div className="flex items-center gap-3">
                     ...
                     <span className="text-[12px] font-black uppercase tracking-tight text-gray-700 group-hover:text-gray-950 transition-colors">
                        {r.name}
                     </span>
                  </div>
      ...
      <div className="bg-gray-900 rounded-[25px] p-6 text-white group">
         <h4 className="text-[12px] font-black uppercase tracking-[0.2em] text-sm-blue mb-4">Request 2025 Lookbook</h4>
         <p className="text-[11px] text-white/40 font-bold uppercase tracking-widest mb-6">Explore 200+ school building designs & resources.</p>
         <button className="w-full py-3 bg-white text-gray-900 font-black rounded-xl text-[11px] uppercase tracking-widest hover:bg-sm-blue hover:text-white transition-all shadow-xl">Download PDF</button>
      </div>
    </div>
  );
};
